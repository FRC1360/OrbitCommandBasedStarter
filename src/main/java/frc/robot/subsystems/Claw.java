...
public class Claw extends Subsystem {
  ...
  // here. Call these from Commands.
    ...
    private DigitalInput hatchSensortop = new DigitalInput(RobotMap.CLAW_DIO_CHANNEL_HATCH_DETECT_TOP);
    private DigitalInput hatchSensorbottom = new DigitalInput(RobotMap.CLAW_DIO_CHANNEL_HATCH_DETECT_BOTTOM);
    ...
    public boolean hasHatchTop(){
        System.out.println(hatchSensortop.get());
